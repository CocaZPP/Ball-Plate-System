...
//		PWM_YY=Y_distance_pwm(loc_y)-Y_speed_pwm((bbq))+820;
    if(mode1_flag==1&&mode2_flag==0&&mode3_flag==0&&mode4_flag==0)
		  {
				PWM_XX=X1_distance_pwm(loc_x)-(X1_speed_pwm(ccp))+680;
		    PWM_YY=Y1_distance_pwm(loc_y)-Y1_speed_pwm((bbq))+820;	
				
				
      }	
			
     else if(mode1_flag==0&&mode2_flag==1&&mode3_flag==0&&mode4_flag==0)	
		 {
		 		PWM_XX=X2_distance_pwm(loc_x)-(X2_speed_pwm(ccp))+680;
		    PWM_YY=Y2_distance_pwm(loc_y)-Y2_speed_pwm((bbq))+820;
		 }
		 
		 else if(mode1_flag==0&&mode2_flag==0&&mode3_flag==1&&mode4_flag==0)	
		 {

		 		PWM_XX=X3_distance_pwm(loc_x)-(X3_speed_pwm(ccp))+680;
		    PWM_YY=Y3_distance_pwm(loc_y)-Y3_speed_pwm((bbq))+820;
//			 if((abs(loc_x-sv_x3)<=30)&&(abs(loc_y-sv_y3)<=30))
//			 {
//				 if(tim==3)
//				 {
//			    	 sv_x3=144;
...
//			 }
		 ...
		 else if(mode1_flag==0&&mode2_flag==0&&mode3_flag==0&&mode4_flag==1)	
		 {
		 		PWM_XX=X4_distance_pwm(loc_x)-(X4_speed_pwm(ccp))+680;
		    PWM_YY=Y4_distance_pwm(loc_y)-Y4_speed_pwm((bbq))+820;
		 }		
...
//		}
		...
		if(loc_x==0 && loc_y==0)
     {
		   PWM_XX=700;PWM_YY=710;
		 }
		else if(mode1_flag==0&&mode2_flag==0&&mode3_flag==0&&mode4_flag==0)	
		{
		   PWM_XX=700;PWM_YY=710;
		} 
		
    TIM_SetCompare2(TIM3,PWM_XX);		//
		TIM_SetCompare4(TIM3,PWM_YY);		//
