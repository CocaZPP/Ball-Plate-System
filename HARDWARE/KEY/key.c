...
u8 mode1_flag=0,mode2_flag=0,mode3_flag=0,mode4_flag=0,mode5_flag=0;
...
void Function()
{
  u8 a;
	...
	switch(a)
	{
	   case 0x01:mode1_flag=1;mode2_flag=0;mode3_flag=0;mode4_flag=0;	TIM_Cmd(TIM3, ENABLE);  //使能TIMx外设

			       break;	
		
		case 0x02:mode1_flag=0;mode2_flag=1;mode3_flag=0;mode4_flag=0;	TIM_Cmd(TIM3, ENABLE);  //使能TIMx外设
	
			break;	
		
		case 0x03:mode1_flag=0;mode2_flag=0;mode3_flag=1;mode4_flag=0;	TIM_Cmd(TIM3, ENABLE);  //使能TIMx外设

			break;						
		
		case 0x04:mode1_flag=0;mode2_flag=0;mode3_flag=0;mode4_flag=1;	TIM_Cmd(TIM3, ENABLE);  //使能TIMx外设

		
			break;		
					
		case 0x05:/*TIM3_Int_Init(10000,7199);PID_Init(0,0,0,0);*/break;
		case 0x06:/*TIM3_Int_Init(10000,7199);PID_Init(0,0,0,0);*/break;
		case 0x07:/*TIM3_Int_Init(10000,7199);PID_Init(0,0,0,0);*/break;
		case 0x08:/*TIM3_Int_Init(10000,7199);PID_Init(0,0,0,0);*/break;
